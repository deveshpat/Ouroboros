...
``ouroboros.kaggle`` so this contract stays importable in bootstrap contexts.
"""
...
from ouroboros.runtime_env import normalize_text
...
_CONTRACTS: dict[str, KaggleLaunchContract] = {
    ...
    CPU_SMOKE_MODE: KaggleLaunchContract(
        ...
        required_cli_args=("-m", "ouroboros.workflow_validation_worker"),
        notebook_path="kaggle-utils.ipynb",
        allowed_from_github_actions=True,
        allowed_manually=True,
        cpu_smoke_safe=True,
