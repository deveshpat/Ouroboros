...
HARD_LESSON_GUARDRAILS: tuple[HardLessonGuardrail, ...] = (
    ...
    HardLessonGuardrail(
        ...
        refs=("tests/test_kaggle_launch_matrix.py", "tests/test_kaggle_notebook_contract.py", "ouroboros/coconut/__main__.py"),
    ...
    HardLessonGuardrail(
        ...
        refs=("tests/test_diloco_worker_fake.py", "ouroboros/utils/wandb_runtime.py"),
    ...
    HardLessonGuardrail(
        ...
        guardrail="Minimal runtime architecture tests assert retired root scripts stay deleted and behavior lives behind package roots.",
        refs=("tests/test_minimal_runtime_public_architecture.py", "tests/test_deep_module_contracts.py"),
        remediation="Keep entrypoints package-owned; do not regrow root workflow monoliths.",
    ...
    HardLessonGuardrail(
        ...
        refs=("ouroboros/coconut/stage_runner.py", "tests/test_training_deep_module_contracts.py"),
    ...
    HardLessonGuardrail(
        ...
        refs=("ouroboros/coconut/cli.py", "tests/test_dgac_anchor_cli_contract.py"),
    ...
    HardLessonGuardrail(
        ...
        refs=("ouroboros/coordinator/kaggle_commands.py", "tests/test_kaggle_launch_contract.py", "tests/test_model_memory_policy.py"),
    ...
    HardLessonGuardrail(
        ...
        refs=("ouroboros/models/loading.py", "tests/test_bootstrap_mac_mps.py", "tests/test_model_memory_policy.py"),
