...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--resume_from_anchor",
        dest="resume_from_anchor",
        action="store_true",
        help=(
            "Load the configured Hub anchor as the base LoRA weights for DGAC "
            "training/eval. Requires --use_halt_gate."
        ),
    )
    parser.add_argument(
        "--resume_anchor_repo_id",
        default="WeirdRunner/Ouroboros",
        help="HF model repo containing the DGAC anchor adapter.",
    )
    parser.add_argument(
        "--resume_anchor_subdir",
        default="diloco_state/anchor",
        help="Subfolder inside --resume_anchor_repo_id containing adapter weights and optional halt_gate.pt.",
    )
    parser.add_argument(
        "--latent_cache",
        action="store_true",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Load the requested checkpoint/Hub anchor, run validation and "
